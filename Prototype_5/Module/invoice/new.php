...
//For Role User
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            <form role="form" class="form-horizontal" method="POST" action="Module/invoice/print.php" enctype="multipart/form-data" target="_blank">
                ...
                <div class="panel-body"> 
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                      <select class="form-control" name="condition" readonly>
                        <option class="active" value="Cash">Cash</option>
                      </select>
                    </div>                  
                  </div>            
                  ...
                  <div class="col-md-12">
                    <div class="pull-right">
                      ...
                      <button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Clean Bag" onclick="showBag('<?php echo 1; ?>')">
