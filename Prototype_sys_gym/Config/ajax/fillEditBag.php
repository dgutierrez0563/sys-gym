<?php
	...
	if($action == 'ajax'){
		...
		$reload = './Module/invoice/edit_invoice.php';
				...
				while ($row=mysqli_fetch_array($query)){
					...
					if($row['Estado'] == "Enabled"){ ?>
						<tr>
							...
							<td>
								<span class="pull-right"><a class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Add" onclick="toEditBag('<?php echo $id_product ?>')"><i class="glyphicon glyphicon-plus"></i></a>
								</span>
							</td>
						</tr>
					<?php
