<section class="content-header">
  <h1>
    <i class="glyphicon glyphicon-tags icon-title"></i> Expense Management
                  ...
                  echo "<tr style='width: auto;'>
                          ...
                          <td class="center">
                            ...
                            echo "<a data-toggle='tooltip' data-placement='top' title='Modify' style='margin-right:1px' class='btn btn-primary btn-xs' href='?module=form_billToPay&form=edit&id=$data[IDCuentaGastos]'>
                                ...
                                <a data-toggle='tooltip' data-placement='top' title='Detail'  class='btn btn-info btn-xs' href='?module=detailExpsense&detail&id=$data[IDCuentaGastos]&option=$option_aux'>
