...
<section class="content-header">
  <h1>
    <i class="fa fa-user icon-title"></i> Customer Information
  </h1>
  <ol class="breadcrumb">
      ...
      <div class="box box-primary">
        ...
        <form role="form" class="form-horizontal"  enctype="multipart/form-data">
          <div class="box-body">      
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Viceral Fat</label>
          ...
          <div class="box-footer">
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <a href="?module=profileCustomer" class="btn btn-primary">Return to List</a>
              </div>
            </div>
          </div><!-- /.box footer -->
        </form>
