            ...
            <form role="form" class="form-horizontal" method="POST" action="Module/supplier/proses.php?act=insert" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="legalidentification" name="legalidentification" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required>
                  </div>                
                </div>

                <div id="result_for_supplier"></div>
            ...
            <form role="form" class="form-horizontal" method="POST" action="Module/supplier/proses.php?act=update" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="legalidentification" name="legalidentification" autocomplete="off" value="<?php echo $data['CedulaJuridica']; ?>" onKeyPress="return goodchars(event,'0123456789',this)" required>
                  </div>
                </div>
