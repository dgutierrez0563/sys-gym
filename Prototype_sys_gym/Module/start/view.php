  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
      <div style="background-color: #00B160;color: #fff;" class="small-box">
        <div class="inner">        
          ...
          <p style="font-size: 18px;"><strong><span class="glyphicon glyphicon-chevron-right"></span> Today's sales</strong></p>
        </div><br>
    ...
    <div class="col-lg-3 col-xs-6">
      <div style="background-color: #FEAA23;color: #fff;" class="small-box">
        ...
        <br><br>
        <h3></h3>
          <p style="font-size: 18px;"><strong><span class="glyphicon glyphicon-chevron-right"></span> Stats</strong></p>
        </div>
        <br>
        <div class="icon" align="right">
...
<!--     <div class="col-lg-3 col-xs-6">
    ...
    <div class="col-lg-3 col-xs-6">
      <div style="background-color: #00c0ef;color: #fff;" class="small-box">
        ...
        <br><br>
        <h3></h3>
          <p style="font-size: 18px;"><strong><span class="glyphicon glyphicon-chevron-right"></span> New Invoice</strong></p>
        </div>
        <br>
        <div class="icon" align="right">
