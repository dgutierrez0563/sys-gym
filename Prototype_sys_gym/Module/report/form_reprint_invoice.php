<section class="content-header">
    <h1>
      <i class="fa fa-search icon-title"></i> Reprint invoice
    </h1>
    <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-12">      
      <div class="box box-primary">
      	<div class="box-body">
	        <form role="form" class="form-horizontal" method="GET" action="Module/report/reprint_invoice.php" enctype="multipart/form-data" target="_blank">
	        <br>
			    <div class="panel panel-info">
			      	<div class="panel-heading">
						<h4><i class='glyphicon glyphicon-document'></i> Search Invoice</h4>
			      	</div>
			      	<div class="panel-body">			          
			        <br>
			            <div class="form-group">
			              <label for="id_invoice" class="col-md-2 control-label">Entry No. Invoice</label>
			              <div class="col-sm-2">
