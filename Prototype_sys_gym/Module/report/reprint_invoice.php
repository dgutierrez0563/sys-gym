		    ...
		    <br>
			    <table cellspacing="0" style="width: 100%;">
			        <tr>
			            ...
			            INVOICE No. <?php echo $data_f['facturaID'];?>
			            </td>
			        </tr>
			    </table>
			    <br>
		            ...
		            <table cellspacing="0" style="width: 100%; border: solid 0.7px black; font-size: 10pt;padding:0.2mm;">
		                <thead style="background:#e8ecee">
		                    <tr class="tr-title">
		                        ...
		                        <th height="25" style="width: 57%;border-bottom:0.1px black;" align="left" valign="middle">Description</th>
		                        <th height="25" style="width: 16%;border-bottom:0.1px black;" align="center" valign="middle">Unit Price</th>
		                        <th height="25" style="width: 16%;border-bottom:0.1px black;" align="center" valign="middle">Total Price</th>
		                    </tr>
		                </thead>
		                <tbody>
					    <?php
					   	...
					   	<?php }
					        ...
					        while ($data_aux_d=mysqli_fetch_array($query_sub)) {
					            ...
					            <tr>
					                ...
					                <td height="20" style="border-bottom:0.1px black;" align="left" valign="middle">Plan subscription for <?php echo $data_aux_d['CantidadDias']." days"." [".$data_aux_d['NombrePlan']."]"; ?></td>
