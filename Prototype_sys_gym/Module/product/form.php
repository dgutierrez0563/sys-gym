            ...
            <form role="form" class="form-horizontal" method="POST" action="Module/product/proses.php?act=insert" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="nameproduct" name="nameproduct" maxlength="40" autocomplete="off" required>
                  </div>
                </div>

                <div id="result_for_product"></div>
            ...
            <form role="form" class="form-horizontal" method="POST" action="Module/product/proses.php?act=update" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Name Product</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="nameproduct" name="nameproduct" maxlength="40" autocomplete="off" value="<?php echo $data['NombreProducto']; ?>" required>
                  </div>
                </div>           
