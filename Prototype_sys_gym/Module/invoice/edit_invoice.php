            ...
            <div class="panel-body"> 
              ...
              <div class="col-md-12">
                <div class="pull-right">
                  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalE" data-placement="left" title="Add Products">
                  ...
                  <button type="button" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="View List" onclick="showEditBag('<?php echo 1; ?>')">
                  <span class="glyphicon glyphicon-shopping-cart"></span> In bag
                  </button>
                  <button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Clean Bag" onclick="clearEditBag()">
              ...
              <div class="modal-body">
                ...
                <form class="form-horizontal">
                  <div class="form-group">
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="q" placeholder="Buscar productos" onkeyup="loadEdit(1)">
                    </div>
                    <button type="button" class="btn btn-success" onclick="loadEdit(1)"><span class='glyphicon glyphicon-search'></span> Search</button>
                  </div>
                </form>
                <div id="loader" style="position: absolute; text-align: center; top: 55px;  width: 100%;display:none;"></div><!-- Carga gif animado -->
                
                <div class='outer_divEdit'></div><!-- Carga los datos ajax -->
