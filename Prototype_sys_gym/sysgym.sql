...
--
-- Host: localhost
-- Generation Time: Apr 30, 2018 at 10:16 PM
...
--
-- Table structure for table `addtobag`
--
...
(1, 'Cheetos', '150.0', 0, 1, 'N/A', 'Enabled', 2, '2018-01-28 04:44:28', 2, '2018-04-26 17:04:57'),
(2, 'Paleta Choco Snack', '200.0', 8, 2, '', 'Enabled', 2, '2018-01-28 05:04:57', 2, '2018-04-26 17:16:24'),
(3, 'Powerade', '800.0', 26, 3, '', 'Enabled', 2, '2018-04-10 18:03:27', 2, '2018-04-26 17:17:04'),
...
(1, 'minor20', '0f58fd4c84c06d780f98702a6a0a2138', '503540125', 'Minor Rojas', 'minor@yahoo.com', '50111324', 'Rio Cuarto', 'que interesante ceuntame todo.jpg', 'Admin', 'Enabled', '2018-01-24 21:52:50', '2018-03-19 15:34:10'),
(2, 'masonhsp', '28017d018848cb86820ab27c06a2d91b', '603650408', 'Harry Mason', 'masonhsp@yahoo.com', '24600013', 'Sta Rita', 'eso es del diablo Papa.jpg', 'Admin', 'Enabled', '2018-01-24 23:32:28', '2018-03-19 15:33:08'),
(3, 'torres20', '6ca7ce10e9fc21c5014a601a5e55b628', '205250124', 'Luis Torres', 'luis@gmail.com', '24601113', 'Venecia, San Carlos', 'ya wey.jpeg', 'User', 'Enabled', '2018-02-24 22:55:42', '2018-04-26 18:01:36');
...
--
-- AUTO_INCREMENT for table `addtobag`
--
ALTER TABLE `addtobag`
...
--
ALTER TABLE `detalleFactura`
  MODIFY `IDDetalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;
--
-- AUTO_INCREMENT for table `factura`
--
ALTER TABLE `factura`
  MODIFY `IDFactura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
--
-- AUTO_INCREMENT for table `perfilCliente`
--
ALTER TABLE `perfilCliente`
...
--
ALTER TABLE `shoppingBag`
  MODIFY `IDShoppingBag` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=319;
--
