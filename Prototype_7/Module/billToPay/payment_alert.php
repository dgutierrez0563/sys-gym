<?php
  if ($_SESSION['Role'] == "Admin") { ?>    
    <section class="content-header">
      <h1>
        <i class="glyphicon glyphicon-tags icon-title"></i> Alerta de Pagos
      </h1>
    </section>
                ...
                while ($data = mysqli_fetch_assoc($query)) { 
                  ...
                  echo "<tr style='width: auto;'>
                          ...
                          <td class="center">
                            ...
                            $option_aux = "Alerts";
                            echo "
                                <a data-toggle='tooltip' data-placement='top' title='Pagar' style='margin-right:1px;' class='btn btn-success btn-xs' href='Module/billToPay/proses.php?act=pay&id=$data[IDCuentaGastos]'>
