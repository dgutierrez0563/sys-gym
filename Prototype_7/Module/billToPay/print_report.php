...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    ...
    <?php
        ...
        <div>
            <table>
                <tr>
                    <td style="width: 450px;">Fecha desde <?php $date_1 = date_create($date_initial); $date_2 = date_create($date_final); echo date_format($date_1,'m/d/Y'); ?> hasta <?php echo date_format($date_2,'m/d/Y'); ?></td>            
            ...
            <table width="100%" border="0.1" cellpadding="0" cellspacing="0" style="margin-left: 6px;">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">No. Factura</th>
                        <th height="20" align="center" valign="middle">Fecha</th>
                        <th height="20" align="center" valign="middle">Proveedor</th>
                        <th height="20" align="center" valign="middle">Estado Factura</th>
                        <th height="20" align="center" valign="middle">Total Comprobante</th>
                    </tr>
                </thead>
                <tbody>
                <?php
