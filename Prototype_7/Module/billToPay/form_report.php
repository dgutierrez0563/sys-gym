<section class="content-header">
    <h1>
      <i class="fa fa-search icon-title"></i> Reporte de Gastos
    </h1>
    <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-12">      
      <div class="box box-primary">
      	<div class="box-body">
        <!-- form start -->
	        <form role="form" class="form-horizontal" method="GET" action="Module/billToPay/print_report.php" target="_blank">
	        <br>
