    ...
    <div class="login-box">
      ...
      elseif ($_GET['alert'] == 1) {
        echo "<div class='alert alert-danger alert-dismissable'>
               ...
               Username o password incorrectos, por favor revisar.
              </div>";
      }
      ...
      elseif ($_GET['alert'] == 4) {
        ...
        echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4>  <i class='icon fa fa-times-circle'></i> Conexion Error -> 500</h4>
               Existen problemas con la conexion al servidor.
              </div>";        
      }
      ?>

      <div class="login-box-body">
        <p class="login-box-msg"><i class="fa fa-user icon-title"></i> Log In</p>
        <br/>
        <form action="Config/login-check.php" method="POST">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="usernameC" placeholder="Username" autocomplete="off" required />
