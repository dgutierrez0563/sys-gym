...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de Administracion | System Gym</title>
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">      
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="fa fa-close" aria-hidden="true"><!--&times;--></span></button>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2018 - <?php echo date('Y') ." Developed by";?> - <a href="http://www.dgutierrezwall.gq" target="_blank">dgutierrez</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
